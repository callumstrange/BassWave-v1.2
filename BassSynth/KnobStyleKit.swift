...
public class KnobStyleKit: NSObject {
    ...
    @objc dynamic public class func drawKnobOne(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 124, height: 124), resizing: ResizingBehavior = .aspectFit, knobValue: CGFloat = 0.5) {
        ...
        //// Color Declarations
        let black = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 0.600)
        let shadowColor = UIColor(red: 0.83, green: 0.97, blue: 1.00, alpha: 1.000)
        let knobBottom = UIColor(red: 0.180, green: 0.180, blue: 0.192, alpha: 1.000)
        let knobLight = UIColor(red: 0.40, green: 0.40, blue: 0.40, alpha: 1.000)
        let knobTop2 = UIColor(red: 0.180, green: 0.141, blue: 0.161, alpha: 1.000)
        let orange2 = UIColor(red: 0.45, green: 0.83, blue: 1.000, alpha: 1.000)

        //// Gradient Declarations
        let edge2 = CGGradient(colorsSpace: nil, colors: [knobBottom.cgColor, knobBottom.blended(withFraction: 0.9, of: knobTop2).cgColor, knobTop2.cgColor, knobTop2.blended(withFraction: 0.6, of: knobLight).cgColor, knobLight.cgColor] as CFArray, locations: [0, 0.23, 0.41, 0.73, 1])!
